...
#
set(PDM_APP_ID       "data_collection")
set(PDM_APP_TARGET   "pdm_datacollection")
set(PDM_APP_PLUGIN   "pdm_datacollectionplugin")
set(PDM_APP_QML_URI  "PdM.DataCollection")

# The macro Maestro's main.cpp checks before calling registerWithShell().
set(PDM_APP_DEFINE   "PDM_HAVE_DATA_COLLECTION")
